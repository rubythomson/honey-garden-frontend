...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n\n  <div class=\"app-splash\">\n    <div class=\"inner\">\n      <img class=\"app-logo\" src=\"/images/honey-garden-logo.png\" />\n      <sl-spinner style=\"font-size: 2em;\"></sl-spinner>\n    </div>\n  </div>\n"]);
...
},{}],"UserAPI.js":[function(require,module,exports) {
"use strict";
...
class UserAPI {
  ...
  async getUser(userId) {
    // validate
    if (!userId) return; // fetch json data
    ...
    if (!response.ok) {
      // console log err
      const err = await response.json();
      if (err) console.log(err); // throw err (exit this function)
  ...
  async readingListHandler(poemId) {
    // validate
    if (!poemId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/profile"), {
      // /profile was /addReadingList
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem adding poem to reading list');
    } // convert response payload into json - store as data
...
class TestView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/profile'), _Router.anchorRoute);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/adults.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Adutls Only (18+)\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Fan Fiction</h1>\n        <p>Parental Guidance Recommended!!!</p>\n        \n      </div>      \n    "]);
...
class PoemAPI {
  async newPost(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/post"), {
      method: 'POST',
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
...
class newPostView {
  ...
  async newPostSubmitHandler(e) {
    ...
    try {
      await _PoemAPI.default.newPost(formData);

      _Toast.default.show("Post Added");
      ...
      if (radioInputs) radioInputs.forEach(radioInput => radioInput.removeAttribute('checked')); // reset file inputs
...
var _adults = _interopRequireDefault(require("./views/pages/adults"));
...
var _browse = _interopRequireDefault(require("./views/pages/browse"));
...
class Router {
  ...
  route(fullPathname) {
    ...
    const route = this.routes[pathname]; // console.log('looking up', fullPathname, Object.keys(this.routes));
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/test":"views/pages/test.js","./views/pages/guide":"views/pages/guide.js","./views/pages/adults":"views/pages/adults.js","./views/pages/library":"views/pages/library.js","./views/pages/save":"views/pages/save.js","./views/pages/post":"views/pages/post.js","./views/pages/browse":"views/pages/browse.js","./views/pages/inbox":"views/pages/inbox.js","./views/pages/support":"views/pages/support.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-poem', class Poem extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  saveLibraryHandler() {
    ...
    dialogEl.className = 'poem-dialog'; // sl-dialog content

    const dialogContent = (0, _litElement.html)(_templateObject(), this.readingListHandler.bind(this));
  ...
  async readingListHandler() {
    try {
      _UserAPI.default.readingListHandler(this.id);

      _Toast.default.show('Poem added to reading list');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  }
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), _App.default.apiBase, this.image, this.name, this.views, this.status, this.pages, this.readingListHandler.bind(this), this.startReadingHandler.bind(this));
  }
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-poem":"components/va-poem.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
